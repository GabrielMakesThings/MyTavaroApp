...
const LinesSVG: React.FC = () => {
  ...
  const heights = [
    351, 353, 351, 353, 351, 353, 351, 351, 351, 313,
    310, 314, 313, 320, 321, 320, 319, 318, 322, 320,
    321, 323, 321, 324, 323, 320, 324, 323, 311, 310,
    327, 323, 324, 321, 323, 322, 324, 320, 323, 324,
    324, 324, 351, 351, 353, 351, 353, 351, 351, 353,
    353
  ];
